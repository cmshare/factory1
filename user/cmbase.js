...
{ var dlg=document.createElement("DIV");
  ...
  dlg.innerHTML='<table width="'+w+'" height="'+h+'" style="border-radius:5px 5px 5px 5px;background-color:#0D9EFA;" align="center"><tr><td height="20" style="color:#ffffff;font-size:9pt;font-weight:bold;" onmousedown ="moveDialog(1,event);" onmousemove="moveDialog(2,event);" onmouseup="moveDialog();" onmouseout="moveDialog();">⊙ '+wndtitle+'</td><td align="right"><img style="cursor:pointer" onclick="self.closeDialog()" src="/images/closebtn1.gif" border=0></td></tr><tr><td colspan="2" style="background-color:#dfdfdf;text-align:center">'+content+'</td></tr></table>';
