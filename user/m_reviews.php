...
<tr>
  ...
  <td width="10%" align="right"><?php if($user_id==$row['userid'] && empty($row['audit'])) echo '<a href="#" onclick="if(confirm(\'确定要删除这条评论吗？\')) AsyncPost(\'mode=del&reviewid='.$row['id'].'\',\'/user/review.php\',function(ret){if(ret){alert(ret);window.location.reload();}});return false;"><img border=0 src="/images/del.gif"></a>'; else echo '<img border=0 src="/images/del1.gif">';?></td>
</tr>
<tr>
