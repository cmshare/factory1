...
.TitleCell{text-align:right;padding-right:10px;BACKGROUND-IMAGE:url(images/topbg.gif);}
</style>
</head>
...
<table width="100%" border="5" align="center" cellpadding="5" cellspacing="5" bordercolor="#CCCCCC" bgcolor="#FFFFFF">
  <tr> 
    <td background="images/topbg.gif">
      ...
      <tr> 
         <td nowrap><b><img src="images/pic5.gif" width="28" height="22" align="absmiddle" />您现在所在的位置是： <a href="admincenter.php">管理首页</a> -> <?php
             $ret=@$_GET['ret'];
             if($ret)$ret='?'.$ret;
             echo ($Order_State>0)?'<a href="mg_orders.php'.$ret.'">客户订单管理</a>':'<a href="mg_privateorders.php'.$ret.'">内部订单管理</a>';?> -> <font color=#FF0000>订单明细</font></b>
        </td>
        <td align="right"><?php
...
<tr>
   ...
   if($Order_State>0){?>
      ...
      <tr height="25" bgcolor="#F7F7F7">
        <td width="100" class="TitleCell"><strong>收 货 人</strong></td>
        ...
        <td width="40%" rowspan="8" valign="top">
           ...
           <tr>
             <td height="100%"  bgcolor="#F7F7F7" valign="top"><textarea  readOnly wrap="VIRTUAL" style="WORD-BREAK: break-all;width:100%;height:150px;font-size: 9pt; border: 1 solid #808080"><?php echo $Order_UserRemark;?></textarea></td>
           </tr>
           </table>		
          </td>
      </tr>
      <tr height="25" bgcolor="#F7F7F7"> 
          <td class="TitleCell"><strong>收货地址</strong></td>
          <td><input type="text" name="address" maxlength=100 value="<?php echo $Order_Address;?>" <?php echo $BaseInputStyle;?>></td>
      </tr>
      <tr height="25" bgcolor="#F7F7F7"> 
          <td class="TitleCell"><strong>联系电话</strong></td>
          <td><input type="text" name="usertel" maxlength=50 value="<?php echo $Order_UserTel;?>"  <?php echo $BaseInputStyle;?>></td>
      </tr>
      <tr height="25" bgcolor="#F7F7F7">
          <td class="TitleCell" ><strong>支付方式</strong></td>
          <td><?php
           ...
           else echo '<input type="text" name="paymethod" maxlength=10 value="'.$Order_PayMethod.'"  '.$BaseInputStyle.'>';
         ?></td>
      </tr>
      <tr height="25" bgcolor="#F7F7F7"> 
          <td class="TitleCell"><strong>物流配送</strong></td>
          <td><?php
if($Order_State<5){
...
?></td>
      ...
      <table width="99%" border="2" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#CCCCCC">
      <tr height="25" bgcolor="#F7F7F7">
          <td width=100 class="TitleCell"><strong>订单备注</strong></td>
          <td><?php if($Order_State==-1 && $IsOrderManager) echo '<form style="margin:0px" method="post" action="?mode=userremark"><input type="hidden" name="ordername" value="'.$OrderName.'"><input type="text" name="userremark" maxlength=100 value="'.$Order_UserRemark.'" style="width:95%"><input type="submit" value="保存"></form>';
      ...
      <tr height="25" bgcolor="#F7F7F7"> 
          <td class="TitleCell"><strong><?php echo ($Order_State>-3)?'下单日期':'入库日期';?></strong></td>
          <td><?php echo $Order_ActionTime;?></td>
      </tr>     
      </table><?php
}?>
