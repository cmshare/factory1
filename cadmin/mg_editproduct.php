...
<SCRIPT language="JavaScript" src="<?php echo WEB_ROOT;?>include/category.js"></SCRIPT>
<SCRIPT language="JavaScript" src="includes/mg_comm.js" type="text/javascript"></SCRIPT>
<script language="javascript" src="checkproduct.js"></script>
<script language="javascript" src="mg_editproduct.js"></script>
<style>
.labelsbox li{
...
.labelsbox li a:hover{
  background:url(/images/close_icons.png) -16px center;
}
</style>
</head>
...
<table width="100%" height="100%" border="5" align="center" cellpadding="5" cellspacing="5" bordercolor="#CCCCCC" bgcolor="#FFFFFF">
  ...
  <tr><form name="myform" method="post" action="mg_saveproduct.php?mode=product" onsubmit="if(!cids_data_generate(this))return false;this.description.value=ueditor.getContent();return CheckSaveProductInfo(this)" target="dummyframe">
    <td height="100%" valign="top" bgcolor="#FFFFFF">
        <input type="hidden" name="id" value="<?php echo $ProductID;?>">
        <input type="hidden" name="recommend" value="<?php echo $recommend;?>">
        <input type="hidden" name="brand" value="<?php echo $prow['brand'];?>">
        <input type="hidden" name="cids" value="<?php echo $prow['cids'];?>">
        <table width="98%" border="2" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#CCCCCC">
          <tr> 
            <td width="150" align="right" background="images/topbg.gif" bgcolor="#f4f4f4"><span style="color:#FF0000" title='必填，不能为空，不能重复'>＊</span><strong>商品名称： </strong></td>
            <td bgcolor="#FFFFFF" nowrap><input name="productname" type="text" class="input_sr" id="productname" value="<?php echo $prow['name'];?>" style="width:100%"></td>
            <td width="280" rowspan="10" align="center" valign="middle" bgcolor="#FFFFFF" ><a href="<?php echo GenProductLink($ProductID);?>" id="preview_img" style="width:280px;height:280px;display:block;background-repeat:no-repeat;background-position:center top;background-size:contain;" target="_blank"></a></td>
          </tr>
          <tr> 
            <td align="right" background="images/topbg.gif" bgcolor="#f4f4f4"><span style="color:#FF0000">＊</span><strong>品牌分类：</strong></td>
            <td bgcolor="#FFFFFF" id="brand_navigation"></td>
          </tr>  
          <tr> 
            <td align="right" background="images/topbg.gif" bgcolor="#f4f4f4"><span style="color:#FF0000">＊</span><strong>导航分类：</strong></td>
            <td bgcolor="#FFFFFF"><div id="cid_labels" style="float:left" class="labelsbox"></div> <div style="float:right" id="cat_navigation"></div></td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="right" background="images/topbg.gif" bgcolor="#f4f4f4" nowrap><strong>商品条码：</strong></td>
            <td bgcolor="#FFFFFF"><input name="barcode" type="text" class="input_sr" id="barcode" value="<?php echo $prow['barcode'];?>" maxlength="20" size="30" onkeyup="if(isNaN(value))execCommand('undo')"> &nbsp;<img src=images/memo.gif alt='请输入实际商品的条形码，如果此商品没有条形码则填0'> </strong> <font color=#FF0000>＊</font></td>
          </tr>
          <tr>
            <td align="right" background="images/topbg.gif" bgcolor="#f4f4f4" nowrap><strong>商品重量：</strong></td>
            <td bgcolor="#FFFFFF"><INPUT NAME="weight" TYPE="text" style="text-align:center" class="input_sr"  VALUE="<?php echo $prow['weight'];?>" maxlength="6" SIZE="30" onkeyup="if(isNaN(value))execCommand('undo')"> 克</td>
          </tr>
          <tr> 
...
ueditor.ready(function(){
   ...
   //ueditor.addListener('contentChange',function(editor){});
   ShowImagePreview("<?php echo $ProductCode;?>"); 
   myform.ConfirmButton.disabled=false;
   InitCategory(myform.brand.value,myform.cids.value);
});
</script>
</body>
</html><?php db_close();?>
