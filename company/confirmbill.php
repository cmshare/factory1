...
<TR valign="top">
  <TD align="center" background="images/client_bg_left.jpg" width=210" height="100%"><?php require('include/guide_help.php');?>
  </TD>  
  <TD id="contentbox">
     <TABLE cellSpacing=0 cellPadding=0 width="100%" height="100%" align="center"  border="0">
     <TR>
        <TD width="100%" height="25" class="pageguider">
          <img src="images/arrow2.gif" width="6" height="7">&nbsp;您現在的位置：&nbsp;<a href=".">主頁</a> &gt;&gt; 收银台——确认订单
        </TD>
     </TR>
     <TR>
        <TD valign="top" style="padding:15px"><?php require('user/m_confirmbill.php');?></td>
      </tr>
     </TABLE>
  </TD>
</TR>
